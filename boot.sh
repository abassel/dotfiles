...
function __install_all {
    ...
    wget --backups=3 https://raw.githubusercontent.com/abassel/dotfiles/master/.zshrc
    wget --backups=3 https://raw.githubusercontent.com/abassel/dotfiles/master/.functions.sh
    wget --backups=3 https://raw.githubusercontent.com/abassel/dotfiles/master/.alias_exports.sh
