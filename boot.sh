...
export _apps='tree lsof jq vim git wget crudini bash-completion git etckeeper telnet sed screen tmux' # glances colordiff python3-pip python3 python-pygments'
