...
function gm() {
    ...
    printf "Executing ${YELLOW}$command_to_execute${NC} in all repos under ${MAGENTABRIGHT}$PWD${NC}\n"
...
function gm1() {
    ...
    printf "Executing ${YELLOW}$command_to_execute${NC} in repos one level under ${MAGENTABRIGHT}$PWD${NC}\n"
...
function gm2() {
    ...
    printf "Executing ${YELLOW}$command_to_execute${NC} in repos two levels under ${MAGENTABRIGHT}$PWD${NC}\n"
